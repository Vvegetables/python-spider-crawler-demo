...
#TypeError: __call__() got an unexpected keyword argument 'fields'
...
#     _connect.insert('educationnews', fields=('title','link'), values=('测试','www.baidu.com'))
    k = _connect.batch_insert('doctor_lib', fields=['college','major','direction','method','teacher','subject'], values=[[u'003电气与控制工程学院',u'081100控制科学与工程(8)',u'01城市道路信号控制优化理论与技术(2)','全日制','刘小明(1)','①1001英语②2001控制工程基础③3001交通工程学']])
    print k
